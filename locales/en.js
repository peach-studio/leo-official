module.exports = {
  lang: 'English',
  head: {
    title: 'Leo - High-performance decentralized ecosystem',
    document: 'Document',
    description: {
      index: 'Leo - High-performance decentralized ecosystem',
      careers: 'Welcome to join our Leolabs, Let\'s create A New Generation of High-performance Decentralized Application Platform',
      faq: 'All about FAQs of Leo',
      technology: 'The key technologies of Leo: DAG、Snapshot Chain、Asynchronous Architecture、Reactive Contract、Quota leasing、Loopring Integrated、Timer scheduling、Contract Upgrade、solidity++'
    }
  },
  exchange: {
    okex: 'OKEX.COM'
  ...
  feature: {
    performance: {
      ...
      dag: {
        title: 'DAG Ledger',
        content: 'Transactions in Leo are grouped by accounts.  That is, each transaction only changes the state of one single account.  Send transactions are separated from receive transactions, thereby obviating the need to wait for a transfer to be complete before the initiation of another transaction. The hierarchical design of the consensus algorithm allows horizontal scalability in consensus groups.'
      },
      async: {
        title: 'Asynchronous Architecture',
        content: 'Leo splits transactions into transaction pairs according to a "request-response" pattern. The writing and verification of transactions are asynchronously decoupled, thereby supporting ultra-high throughput. Inter-contract communications are based on an asynchronous messaging model.'
      }
    },
    reactiveContract: {
    ...
    ecosystem: {
      ...
      value: {
        ...
        content: 'Leo itself is a decentralized exchange that supports digital asset issuance, cross-chain value transmission, and inter-token transactions based on the Loopring protocol.  A quota-based resource allocation mechanism allows light users to pay zero fees and gas. Users can obtain computing resources in multiple ways.  Leo also supports quota leasing.'
      },
      dapp: {
        title: 'dApp Mini Programs',
        content: 'The Leo client features an engine for creating HTML5-based decentralized mini programs.  This engine simplifies the process of dApp development and deployment.'
      }
    }
  },
  roadmap: {
    ...
    timelines: [
      ...
      {
        'time': 'April 2018',
        'description': 'System design of Leo, completion of white paper'
      },
      {
        'time': 'May 2018',
      ...
      {
        'time': 'June 2018',
        'description': 'Beginning of Leo Core\'s R&D'
      },
      {
        'time': 'Oct 2018',
        'description': 'Leo Core alpha'
      },
      {
        'time': 'Dec 2018',
        'description': [
          'Leo Core beta M1: Trading / Issuance of assets / Hierarchical consensus algorithm / Snapshot chain',
          'Release Leo SDK',
          'Leo Blockchain browser'
        ]
      },
      {
        'time': 'Jan 2019',
        'description': 'Desktop client of Leo'
      },
      {
        'time': 'Feb 2019',
        'description': 'Alpha version of Leo mobile app'
      },
      {
        time: 'April 2019',
        description: [
          'Leo Core beta M2: Smart Contract / Solidity++ Compiler / Smart Contract API Documentation'
        ]
      },
      {
        'time': 'May 2019',
        'description': [
          'Leo Core beta M3: Quota leasing / Contract timing scheduling / VNS naming services',
          'Leo dApplet support within Mobile app'
        ]
      },
      {
        'time': 'July 2019',
        'description': 'Leo Core beta M4：Loopring / Ethereum cross-chain gateway'
      },
      {
        'time': 'Aug 2019',
        'description': 'Leo integrated decentralized trading function within Mobile app'
      },
      {
        'time': 'Oct 2019',
        'description': 'Leo Core beta M5: Contract upgrade / Block pruning / Solidity++ optimization'
      },
      {
        'time': 'Nov 2019',
        'description': 'Leo TestNet Release'
      },
      {
        'time': 'Jan 2020',
        'description': 'Leo 1.0 Release'
      },
      {
        'time': 'Feb 2020',
        'description': 'Kickoff of plan for ecosystem development in Leo'
      }
    ]
  },
  elector: {
    ...
    'nameMap': {
      'Leocity': {
        ...
        photo: [],
        medium: ['1. First of all, we are trying to increase the exposure rate of Leo in many vertical blockchain medias including 8btc, Jinse Finance, Lian Dede etc., we leave open the possibility that adopting the form of setup a node column.',
          ...
          '3. Periodically plan for community airdrops and try to get more and more fans of Leo constantly.'],
        plan: ['1. Increasing the exposure rate of Leo by blockchain medias, wallet, market trending apps, setting up accounts of various social medias and charging by professionals, evangelizing the technical advantages of Leo project and retweeting the official announcement and progress of project.',
          '2. Designing Leo themed products and organizing offline meetup of fans regularly, meanwhile, the community will be in charge of professionals and combine with official meetup event as well as media, wallet market trending apps to plan for airdrops.',
          '3. Making some incentive plans to activate community developers to support the up-coming dApp development of Leo ecosystem.'],
        'name': 'LeoCity',
        'description': 'Make Leo-blockchain stronger ！'
      },
      'tenzor': {
        ...
        plan: ['Our team has huge experience in investor relation field. We always help our portfolio projects with the community development and the adoption of the technology.',
          ...
          'As a result, our team has the great value proposition for Leo community and we could bust the development and adoption of the project.'],
        name: 'Tenzor',
        description: 'Unite the world through the blockchain technology.'
      },
      'snap': {
        info: ["Mathew Pham (AKA plasmo) I first got first interested in crypto/blockchain when I found out about Bitcoin in 2012. Invested in a small amount and ever since then, I've truly fallen in love with everything crypto/blockchain-related (especially smart contracts). I've dabbled before in hosting nodes, mining and investing/using one of the first ever mass produced Bitcoin miners (Kncminer), beta testing in the first ever version of Ubuntu Linux back in 2004 and even operating my own business hosting gaming servers/competitions. I discovered Leo back in May, read the Leo Whitepaper, looked over the team's extensive background and thought to myself that this could be become something big. I want to help Leo grow. I am located in Melbourne, Australia."],
        config: ['Intel i5-8600K (6 cores), 16GB DDR4 memory, Samsung SSD, 100Mbps connection'],
        location: ['Melbourne, Australia'],
        photo: [],
        medium: ["I have a Twitter created to provide status on node status, read updates on the Leo ecosystem, and to find out about important events. I have also created a website where users will be able to visit and view node/network status, use the vote calculator to see Leo earning potential, read tutorials and to enter competitions. Forging rewards will also be used to create media, advertisements on Twitter and Reddit, and basically anything to help promote Leo's growth. I'm open to all ideas. "],
        plan: ['Create articles about the Leo platform/ecosystem, provide basic tutorials (for newcomers to read and learn), program/design a calculator to show how much a voter can earn just by voting for Snap Secure supernode, provide competitions so community can grow/become involved and also a possibility to help provide funding for developers to create Leo Dapps or migrate Ethereum Dapps over to the Leo platform.'],
        name: 'SnapSecure',
        description: "Securing Leo's Snapshot Chain, One Block At A Time."
      },
      'ux': {
        ...
        photo: [],
        medium: ['in progress..'],
        plan: ["General strategy of building community in progress for now, need a few days for introducing it. In plans: - build a new site for SBP (design like https://uixagency.com) - add Leo as payment method for our outsourced projects - we want to create an e-shop of exclusive limited jewellery collection or many, one of this collections could be designed with Leo logo - for example ... this idea is flashing in my mind just now - trying to integrate Leo in mobile games and apps - we have gamedev and appdev departments to our team really likes Leo Platform, that's why we accumulate about 2.5 mil Leo and ready for helping to integrate Leo tokens in our reality :)"],
        name: 'UX SBP',
      ...
      'loopring': {
        ...
        plan: ['we currently have an over 200K blockchain community. we are planning to promote and advocate Leo in our community.'],
        name: 'Loopnode',
      ...
      'zhizifund': {
        ...
        photo: [],
        plan: ['1. Leo project incubation: Zhizi Fund is a BVI fund focusing on blockchain technology and cryptocurrency investment. As an early investment institution of Leo, we will also actively participate in the incubation of Leo\'s early projects and provide full support for investment, operation and technology for Leo ecological project partners.',
          '2. There are many partners of Zhizi Fund: since our establishment, Zhizi Fund has established good cooperative relations with many well-known projects domestic and overseas. We will provide Leo with resource cooperation and resource integration to promote the development of Leo.',
          '3. Overseas market expansion: Overseas has always been the focus of investment and cooperation of Zhizi Fund. We also have our own operation center in Australia. We will provide more resources for overseas cooperation and market expansion for Leo.',
          '4. Community and media: Zhizi Fund has a good cooperative relationship with a number of high-quality medias, which can enhance the overall promotion of Leo. Offline meetups, etc.;',
          '5. Highly recognizable Leo\'s development philosophy: Leo is a new generation of responsive blockchain, providing a reliable public platform for industrial decentralized applications. The development direction of the public chain advocated by Leo is highly consistent with the Zhizi Fund, and the Zhizi Fund will fully promote the development of Leo ecological construction.'],
        medium: ['Official Website',
          ...
          'Twitter'],
        name: 'ZVnode',
        description: 'Zhizi Fund, support for the development of Leo ecosystem'
      },
      'linknode': {
        ...
        plan: ['Linknode is backed up by LinkVC, a crypto fund committed to serving outstanding companies and developers in the field of blockchain with global commercial resources and professional financial services. In the past two years, linkVC invested dozens projects worldwide including Aicoin, BBEX, aelf, Zilliqa, Blockv, Certik, Oasis labs, etc.',
          '1. We have strong competitive advantages in both media exposure and industry resources. Having linknode as a super node, Leo can easily cooperate with other top tier projects to enhance community‘s influence.',
      ...
      'bitLeo': {
        ...
        plan: ['2018 is destined to be an extraordinary year. Under the bright sunshine of the great transformation of the 40th anniversary of reform and opening up, the blockchain field has gradually penetrated into all walks of life and exerted its "credit value" function. Looking back at the 2017 chain and the currency circle, there is no doubt that "a big Yangxian can change the belief", "as long as you buy and hold, you can lie down and make money" hot market, but the tide will eventually recede, the economic market No one can guarantee that compared with the chain and the currency circle, it is necessary to effectively reflect the value of the team, accelerate the integration with the real economy, and cooperate with the common promotion of policies, technologies and markets to optimize the traditional industrial model and help the high quality. development of. As a public chain based on DAG technology, Leo proposes a forward-looking point of view of joint governance, and publicly selects high-quality talents with ability, condition, responsibility and ideal blockchain. As the candidate for Leo nodes, the following three points are bit dimensions. Community development planning:',
          'The first, It is imperative. In the context of the Internet, where the demographic dividend is gradually fading, and the once-popular but eclipsed sharing economy, the blockchain focuses on assisting the transformation and upgrading of the industry. When the bit dimension succeeds as one of the Leo nodes, our team or community will follow. The official pace of Leo, in conjunction with the official completion of the node\'s responsibilities, participate in the Leo node co-construction and optimization steps. The Leo node is only one part of the community construction. The members of the Bit Dimensional team have doubled computer science and technology and financial economics, are proficient in various computer development languages, have more than five years of experience in the financial industry, and coincide with the blockchain field. Solid technical skills and rich experience in the development and operation of blockchain projects have made our bit dimension team more confident to be able to work on Leo nodes. At the same time, there are also Leo and Loopring positions among team members, which is a solid guideline protocol. Advocates and enthusiasts;',
          'Second, Take a multi-pronged approach. Community and ecological construction need both hard and soft. On the one hand, the bit-dimensional team with experience in node selection has a complete set of server resources, provides a series of technical support, and arranges real-time monitoring of nodes to ensure stable operation of the system; In the process of promoting Leo\'s ecological construction, the Bit Dimensional team currently has thousands of communities and mature ecological promotion and organization experience, and effectively uses the bit dimension public number, bit dimension financial website and other self-media channels and consulting communities. The technical community co-catalyzes, effectively promotes Leo, knows Leo in a popular way, understands Leo in depth, and enthusiastically joins Leo. Anyone who contributes to the bit-dimensional node, whether it is community construction or technical maintenance, will be 20% of the proceeds are incentives and 5% are outstanding contributions. And the Bit Dimensional team will also combine their own project comprehension, share technical documentation, answer and guide the Leo technology community. At the same time, the bit dimension has the experience of Dapp landing application development, and has developed distributed applications based on the underlying technology of eos and sidechain fibos. Currently, it has a deep understanding and familiarity with Leo related technical documents for the later application of ecological construction. get ready;',
          'Third, Be prepared for the rain. The Bit Dimensional Team firmly believes that in the context of the new era, the new journey, and the new mission, the blockchain revolution must be able to subvert the traditional, complex, over-centered, and inefficient system, serving more transparent and efficient And fair areas. Therefore, the bit-dimensional team is not only committed to node construction, but will use a more precise angle and more abundant power to make a combination of community construction and application development. In the future, the bit dimension team will implement “four more”. : Put forward more Leo project ideas, issue more applications, recruit more investment institutions, and recruit more people of insight.',
          'We always believe that Leo will be the leader, not only bringing the next bull market, but also leading the blockchain era, and the bit dimension, more depth!'],
        medium: ['1. We have created a blockchain media bit dimension (bitewd.com) in China to increase the Leo exposure rate, and will adopt the form of opening Leo knowledge column, node column, etc.;',
          ...
          '3. Create multiple Leo WeChat groups or telegraph groups, and continuously acquire new Leo fans through diversified dapps developed by the team.'],
        name: 'BitLeo',
        description: 'For Leo！For Freedom'
      },
      'swissLeo': {
        ...
        plan: ['Promotion of Leo through our website (http://swissLeo.org/, in development), social media channels and meetups in Switzerland and European countries'],
        ...
        name: 'Swiss Leo',
        description: 'Your Leo community at the heart of Europe'
      },
      'xinsheng': {
        ...
        plan: ['1. Promote community cooperation, organise existing communities and create new community promotion of Leo.',
          '2. Integrate resources within the company\'s industry, including media, community, capital, and project parties to assist Leo in promoting business cooperation.',
          '3. Establish a Leo supernode (SBP) community to help new users understand the basics of Leo.'],
        medium: ['WeChat official account, Weibo, Twitter, Bihu, Telegram'],
        name: 'XinShengFund',
        description: 'Shoot for the Leo'
      },
      'zlnode': {
        ...
        name: 'ZL node',
        description: 'Working for better Leo'
      },
      'loopnest': {
      ...
      'belsona': {
        ...
        plan: ['We have a strong network. We are in contact with several projects and startups. Some of them are searching for suitable to their dapps ecosystem. We are friends with Belarus blockchain association. Quite often we participate in the blockchain conferences. We plan to showcase people Leo blockchain, explain why it is better than the others and help to migrate their project or understand how to do this.'],
        medium: ['We have 2 big social media: Telegram channel (https://t.me/ICOFanatics) and Twitter (https://twitter.com/icofanatics). Where we follow the projects we like and share news with our community. Of course, we will provide a media coverage to all news and events about Leo'],
        name: 'Belsona Investment Group LP',
        description: 'In Leo we trust'
      }
    }
  },
  team: {
  ...
  superNodes: {
    ...
    'contents': [{
      ...
      'second': [{
        ...
        'answer': [
          '1. Migrate the Leo ERC20 tokens you wish to stake for your SBP. <br/> In mid-November, migrate your ERC20 Leo tokens to the Leo TestNet via the smart contract provided by Leo. ',
          '2. Stake 500,000 Leo (this amount will increase to 1,000,000 Leo after the MainNet is launched). These tokens will be locked for 3 months, as required for SBPs. ',
          '3. Receive at least 200,000 votes (each vote is represented by one Leo). With each new community supernode that receives a minimum of 200,000 votes, Leo will stop one of its own official supernodes running. The community supernode will become the new supernode. ',
          '4. Run the server for the SBP (more detailed information will be released later)'
        ]
      }, {
        'title': 'Voting',
        'answer': [
          '1. Each Leo can only be used to vote for one SBP. ',
          '2. Each address can only be used to vote for one SBP. The number of votes from that address will equal the entire amount of Leo held in that address. ',
          '3. Voting from a given address does not lock up the Leo tokens stored at that address. These tokens may be transferred at any time, however, it would inherently affect the total number of votes going towards the supernode.',
      ...
      'answer': [
        '1. SBPs ensure that the Leo system functions properly. SBPs must pack transactions in the entire network and ensure stability of the system by providing usable server resources. In addition, operators of the SBPs are also expected to provide technical support for the Leo system to the best of their abilities.',
        '2. SBPs are representatives, evangelists, and leaders of the Leo community and are expected to take actions to build and preserve an active and healthy community. ',
        '3. The prosperity of the Leo community goes hand in hand with the success of the Leo ecosystem. SBPs are expected to evangelize Leo, and help create dApps based on Leo. '
      ]
    }, {
      'orderNum': 'IV.',
      'question': 'Incentive Plan',
      'answer': [
        '1. Forging SBPs in TestNet stage will share annual forging rewards, equivalent to 3% of the total issued token amount. This translates to 30 million Leo (3% of the current total supply of 1 billion Leo). ',
        "2. supernode rewards are divided into two parts: 50% for creating blocks and 50% for voting. Among the 30 million token rewards per year, 15 million are awarded to the supernodes that create blocks, and 15 million are awarded to the supernodes that were elected by the community (in TestNet stage, this will be the top 100 supernodes).<br/>If a supernode were to keep mining for one year, it could get 600,000 Leo from the block creation reward ((30 million / 25 nodes) * 50%), plus the reward from voting.<br/> Voting reward calculation: according to the supernode's stake and voting ratio, (the node staking tokens + voting) / (all supernode staking tokens + all voting) * (voting reward). Each round will be 75 seconds. The daily sum would be multiplied by the block rate.<br/>A single supernode daily reward would be: 1,643.835 Leos of blocks creation rewards, plus additional staking/voting rewards",
      ...
      'orderNum': 'V.',
      'question': 'An explanation of the Leo token in TestNet',
      'answer': [
        '1. The Leo tokens in TestNet are used for SBP election and voting. They are added to the network from the mapping of Leo ERC20 tokens.',
        '2. The transfer of Leo ERC 20 tokens to Leo TestNet tokens cannot be reverted. You will not be able to circulate the TestNet tokens on the secondary market in the short term.',
        '3. After the MainNet is launched, Leo tokens on the TestNet and Leo ERC20 tokens will both be converted to Leo tokens on the MainNet. '
      ]
    }]
  },
  faq: {
    ...
    'questions': [
      ...
      {
        'question': 'What is the relationship between Leo and Loopring?',
        'answer': [
      ...
      {
        question: 'Will there be airdrops for Leo? In what way?',
        answer: [
          'There will be. Stay tuned for amount and mechanism.'
        ]
      },
      {
        question: 'Which exchange(s) will Leo be listed on?',
        answer: [
      ...
      {
        question: 'What is the public WeChat account of Leo?',
        answer: [
      ...
      {
        question: 'What is Leo’s biggest innovation as compared to other public chains?',
        answer: [
      ...
      {
        question: 'Since smart contracts in Leo don’t support synchronous calls, how will such calls in Ethereum be compatible with Leo?',
        answer: 'Unfortunately, these calls are not compatible with Leo.  Synchronous calls need to be changed to asynchronous calls to work in Leo.'
      },
      {
        question: 'What is the difference between Leo\'s Solidity++ and Ethereum’s Solidity?',
        answer: [
      ...
      {
        question: 'The whitepaper mentions that Leo’s development tools are similar to, and have features extended from, those of Ethereum.  Does this indicate that dApp’s for Ethereum can be deployed on Leo with minor changes?',
        answer: [
      ...
      {
        question: 'Can Leo’s smart contracts support running on a mobile device?  Will they be similar to Qtum and support mainstream languages like C++ and Java?',
        answer: [
  ...
  urlSrc: {
    telegram: 'https://t.me/Leo_en',
    whitePaper: '/whitepaper/Leo_en.pdf',
    introduction: 'https://Leo.wiki/introduction/'
  },
  utils: {
    readMore: 'Read More'
  },
